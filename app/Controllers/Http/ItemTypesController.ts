...
export default class ItemTypesController {
  ...
  //   try {
  //     const itemType = await ItemType.find(params.id)
  //     if (itemType) {
  //       return itemType
  //     }
  //   } catch (error) {
  ...
  //   const itemType = await ItemType.find(params.id)
  //   if (itemType) {
  //     const imgPath = await importImage('defaultImgs/itemTypes/', request.file('image'))
  //     itemType.name = request.input('name')
  //     itemType.description = request.input('description')
  //     itemType.consumable = request.input('consumable')
  //     itemType.max_stack = itemType.consumable ? request.input('max_stack') : 1
  //     // @ts-ignore
  //     itemType.image_url = imgPath
  //     if (await itemType.save()) {
  //       return itemType
